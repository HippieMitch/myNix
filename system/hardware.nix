...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/9ee13ee7-ddaa-4055-b709-7605eeaea53f";
      fsType = "btrfs";
  ...
  boot.initrd.luks.devices = {
      nixcrypt = {
        device = "/dev/disk/by-uuid/13eb1068-f6e9-4140-967d-61fbfd52eaca";
        allowDiscards = true;
      };
   };
  ...
  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/ABF7-E2A7";
      fsType = "vfat";
    };
