...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/bd7593e5-1681-4dae-9a4b-6fe5ba52e3d8";
      fsType = "btrfs";
  ...
  boot.initrd.luks.devices=
    { nixcrypt = {
      device = "/dev/disk/by-uuid/282f781f-3697-4757-84be-bf1627aa2766";
      allowDiscards = true;
      };
    };
  ...
  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/BD9C-6EB1";
      fsType = "vfat";
    };
