...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/5b6d6d9b-5681-417f-9428-ea978e87850c";
      fsType = "btrfs";
    ...
    boot.initrd.luks.devices = {
      nixcrypt = {
        device = "/dev/disk/by-uuid/91b808ee-41b0-4f4a-aefd-aa8f05f33734";
        allowDiscards = true;
      };
    };
  ...
  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/BC0E-1639";
      fsType = "vfat";
    };
