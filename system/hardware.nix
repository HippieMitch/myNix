...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/a9255e3c-4e1a-4d60-8c52-fd8cad980ac0";
      fsType = "btrfs";
  ...
  boot.initrd.luks.devices = {
    nixcrypt = {
      device = "/dev/disk/by-uuid/de3dd404-6daf-4c75-bc03-603872878a88";
      allowDiscards = true;
    };
  };
  ...
  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/F392-94FE";
      fsType = "vfat";
    };
